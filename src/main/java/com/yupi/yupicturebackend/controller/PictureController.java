...
import com.yupi.yupicturebackend.constant.SpaceUserPermissionConstant;
...
//    }
    ...
    @SaSpaceCheckPermission(value = SpaceUserPermissionConstant.PICTURE_EDIT)
    public BaseResponse<CreateOutPaintingTaskResponse> createPictureOutPaintingTaskRequest(@RequestBody CreatePictureOutPaintingTaskRequest createPictureOutPaintingTaskRequest, HttpServletRequest request) {
        if (createPictureOutPaintingTaskRequest == null || createPictureOutPaintingTaskRequest.getPictureId() == null) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR, "图片资源不存在");
        }
        User loginUser = userService.getLoginUser(request);
